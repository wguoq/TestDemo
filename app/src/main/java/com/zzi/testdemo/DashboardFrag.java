...
public class DashboardFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        //OnClickListener
        CardView cardView1 = v.findViewById(R.id.cardView);
        cardView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed("DashboardFragTag1");
            }
        });
        ...
        cardView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed("DashboardFragTag2");
            }
        });
        ...
        cardView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed("DashboardFragTag3");
            }
        });
        ...
        cardView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed("DashboardFragTag4");
            }
        });
        ...
        cardView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onButtonPressed("DashboardFragTag5");
            }
        });
    ...
    private void onButtonPressed(String tag) {
        if (mListener != null) {
